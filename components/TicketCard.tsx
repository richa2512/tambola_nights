...
export function TicketCard({ ticket, calledNumbers = new Set(), interactive = false, onNumberClick }: TicketCardProps) {
  return (
    <div className="bg-card w-full max-w-2xl border border-border shadow-sm rounded-xl overflow-hidden glass mix-blend-normal">
      <div className="bg-primary-600 dark:bg-primary-800 text-white p-3 flex justify-between items-center border-b border-primary-700">
        <div>
          <h3 className="font-bold tracking-wider uppercase text-lg leading-none">Tambola Housie</h3>
            ...
            row.map((cell, cIdx) => {
              ...
              return (
                <motion.div
                  ...
                  className={cn(
                    "aspect-square flex items-center justify-center rounded-lg border text-base sm:text-xl md:text-2xl font-bold transition-all",
                    cell === null 
